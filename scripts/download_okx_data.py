...
This script downloads OHLCV data from OKX exchange.
...
def download_okx_ohlcv(
    ...
    # OKX limit is 100-300 candles per request
    limit = 100
    ...
    filename_base = f"{symbol_clean}_{timeframe}_{start_date}_{end_date}_OKX"
